...
# configs
AUUID=21d74b11-2fa6-411a-9e44-d46494d9b138
CADDYIndexPage=https://github.com/PavelDoGreat/WebGL-Fluid-Simulation/archive/master.zip
CONFIGCADDY=https://raw.githubusercontent.com/ert2j8tnjh/yuhjiolkmjh87/master/etc/Caddyfile
CONFIGXRAY=https://raw.githubusercontent.com/ert2j8tnjh/yuhjiolkmjh87/master/etc/xray.json
